...
const ProdInfo = (props) => {
    ...
    const showProductTags = (detail) => (
        <div className=" flex flex-col justify-between mt-4">
            <div className='flex flex-row justify-between my-3'>
                {detail.shipping ?
                    <p className="font-medium text-base leading-4 text-green-600">Free Shipping Any Loacation</p>
                    :
                    <p className="font-medium text-base leading-4 text-red-600">No Free Shipping</p>
                }

                <MdLocalShipping className='text-xl ml-10' />
            </div>

            <div className='flex flex-row justify-between my-3'>
                {detail.available ?
                    <p className="font-medium text-base leading-4 "><strong className='text-green-600'>{detail.available} </strong>Products is Available</p>
                    :
                    <p className="font-medium text-base leading-4 text-red-600"><strong>No Available</strong></p>
                }

                <DoneOutlineIcon className='text-xl ml-10 text-green-800' />
            </div>
    ...
    return (
        ...
        <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
            <p className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-bold text-xl text-blue-400 leading-4">{detail.brand.name}</p>
            <h2 className="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-blue-900 mt-4">{detail.model}</h2>
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-7 overflow-x-auto">{detail.description}</p>
            <p className=" font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 mt-6 ">$ {detail.price}</p>
            ...
            <div className="lg:mt-11 mt-10">
                <div className="flex flex-row justify-between">
                    ...
                    <div className="flex">
                        ...
                        <input id="counter" aria-label="input" className="border border-gray-300 h-full text-center w-14 pb-1" type="text" />
